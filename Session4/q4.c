...
void drawtriangle(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2, GLfloat x3, GLfloat y3,int depth)
{
  if(depth==0)
  ...
  else
  {
    ...
    drawtriangle(mx2,my2,mx3,my3,x3,y3,depth-1);
  }
}
void changefunc()
{
  ...
  GLfloat x1=-1.0,y1=-1.0;
  GLfloat x2=1.0,y2=-1.0;
  GLfloat x3=0.0,y3=1.0;
  int depth=4;
